...
pub fn parse_cards() -> BinResult<Vec<(String, String)>> {
    ...
    loop {
        ...
        if axes_headers.iter().any(|header| card.starts_with(header)) {
...
pub fn open_header_axes(file_path: &str) -> BinResult<FitsHeader> {
